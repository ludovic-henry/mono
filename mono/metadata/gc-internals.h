...
MonoHandle mono_handle_gc_alloc_pinned_obj (MonoVTable *vtable, size_t size, MonoError *error);
MonoHandle mono_handle_gc_alloc_obj (MonoVTable *vtable, size_t size, MonoError *error);
