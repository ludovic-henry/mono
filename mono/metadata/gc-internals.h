...
gpointer mono_gc_handle_out_of_memory (size_t size);
...
MonoHandle* mono_gc_handle_alloc_pinned_obj (MonoVTable *vtable, size_t size);
MonoHandle* mono_gc_handle_alloc_obj (MonoVTable *vtable, size_t size);
MONO_HANDLE_TYPE (MonoArray)* mono_gc_handle_alloc_vector (MonoVTable *vtable, size_t size, uintptr_t max_length);
MONO_HANDLE_TYPE (MonoArray)* mono_gc_handle_alloc_array (MonoVTable *vtable, size_t size, uintptr_t max_length, uintptr_t bounds_size);
MONO_HANDLE_TYPE (MonoString)* mono_gc_handle_alloc_string (MonoVTable *vtable, size_t size, gint32 len);
