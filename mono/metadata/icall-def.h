...
ICALL(ITHREAD_1, "Abort", ves_icall_System_Threading_InternalThread_Abort)
ICALL(ITHREAD_2, "ClrState", ves_icall_System_Threading_InternalThread_ClrState)
ICALL(ITHREAD_15, "Construct", ves_icall_System_Threading_InternalThread_Construct)
ICALL(ITHREAD_3, "DecCriticalRegionLevel", ves_icall_System_Threading_InternalThread_DecCriticalRegionLevel)
ICALL(ITHREAD_5, "GetApartmentState", ves_icall_System_Threading_InternalThread_GetApartmentState)
ICALL(ITHREAD_6, "GetIsThreadPoolThread", ves_icall_System_Threading_InternalThread_GetIsThreadPoolThread)
ICALL(ITHREAD_7, "GetManagedID", ves_icall_System_Threading_InternalThread_GetManagedID)
ICALL(ITHREAD_8, "GetName", ves_icall_System_Threading_InternalThread_GetName)
ICALL(ITHREAD_9, "GetSerializedPrincipal", ves_icall_System_Threading_InternalThread_GetSerializedPrincipal)
ICALL(ITHREAD_10, "GetSerializedPrincipalVersion", ves_icall_System_Threading_InternalThread_GetSerializedPrincipalVersion)
ICALL(ITHREAD_11, "GetStackSize", ves_icall_System_Threading_InternalThread_GetStackSize)
ICALL(ITHREAD_12, "GetState", ves_icall_System_Threading_InternalThread_GetState)
ICALL(ITHREAD_13, "GetThreadID", ves_icall_System_Threading_InternalThread_GetThreadID)
ICALL(ITHREAD_14, "IncCriticalRegionLevel", ves_icall_System_Threading_InternalThread_IncCriticalRegionLevel)
ICALL(ITHREAD_16, "SetApartmentState", ves_icall_System_Threading_InternalThread_SetApartmentState)
ICALL(ITHREAD_17, "SetIsThreadPoolThread", ves_icall_System_Threading_InternalThread_SetIsThreadPoolThread)
ICALL(ITHREAD_18, "SetManagedID", ves_icall_System_Threading_InternalThread_SetManagedID)
ICALL(ITHREAD_19, "SetName", ves_icall_System_Threading_InternalThread_SetName)
ICALL(ITHREAD_20, "SetSerializedPrincipal", ves_icall_System_Threading_InternalThread_SetSerializedPrincipal)
ICALL(ITHREAD_21, "SetSerializedPrincipalVersion", ves_icall_System_Threading_InternalThread_SetSerializedPrincipalVersion)
ICALL(ITHREAD_22, "SetStackSize", ves_icall_System_Threading_InternalThread_SetStackSize)
ICALL(ITHREAD_23, "SetState", ves_icall_System_Threading_InternalThread_SetState)
ICALL(ITHREAD_24, "SetThreadID", ves_icall_System_Threading_InternalThread_SetThreadID)
ICALL(ITHREAD_25, "Unref", ves_icall_System_Threading_InternalThread_Unref)
...
ICALL(THREAD_1, "ByteArrayToCurrentDomain(byte[])", ves_icall_System_Threading_Thread_ByteArrayToCurrentDomain)
