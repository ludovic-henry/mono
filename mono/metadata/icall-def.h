...
#ifndef HOST_WIN32
ICALL_TYPE(PALSOCKETUNIX, "Mono.PAL.Sockets/Unix", PALSOCKETUNIX_1)
ICALL(PALSOCKETUNIX_1, "Accept", ves_icall_Mono_PAL_Sockets_Unix_Accept)
ICALL(PALSOCKETUNIX_2, "Bind", ves_icall_Mono_PAL_Sockets_Unix_Bind)
ICALL(PALSOCKETUNIX_3, "Connect", ves_icall_Mono_PAL_Sockets_Unix_Connect)
ICALL(PALSOCKETUNIX_4, "GetAvailable", ves_icall_Mono_PAL_Sockets_Unix_GetAvailable)
ICALL(PALSOCKETUNIX_5, "GetLocalEndPoint", ves_icall_Mono_PAL_Sockets_Unix_GetLocalEndPoint)
ICALL(PALSOCKETUNIX_6, "GetRemoteEndPoint", ves_icall_Mono_PAL_Sockets_Unix_GetRemoteEndPoint)
ICALL(PALSOCKETUNIX_7, "Receive", ves_icall_Mono_PAL_Sockets_Unix_Receive)
ICALL(PALSOCKETUNIX_8, "ReceiveBuffers", ves_icall_Mono_PAL_Sockets_Unix_ReceiveBuffers)
ICALL(PALSOCKETUNIX_9, "ReceiveFrom", ves_icall_Mono_PAL_Sockets_Unix_ReceiveFrom)
ICALL(PALSOCKETUNIX_10, "Send", ves_icall_Mono_PAL_Sockets_Unix_Send)
ICALL(PALSOCKETUNIX_11, "SendBuffers", ves_icall_Mono_PAL_Sockets_Unix_SendBuffers)
ICALL(PALSOCKETUNIX_12, "SendFile", ves_icall_Mono_PAL_Sockets_Unix_SendFile)
ICALL(PALSOCKETUNIX_13, "SendTo", ves_icall_Mono_PAL_Sockets_Unix_SendTo)
ICALL(PALSOCKETUNIX_14, "SetBlocking", ves_icall_Mono_PAL_Sockets_Unix_SetBlocking)
ICALL(PALSOCKETUNIX_15, "Socket", ves_icall_Mono_PAL_Sockets_Unix_Socket)
#else
ICALL_TYPE(PALSOCKETWIN32, "Mono.PAL.Sockets/Win32", PALSOCKETWIN32_1)
ICALL(PALSOCKETWIN32_1, "Accept", ves_icall_Mono_PAL_Sockets_Win32_Accept)
ICALL(PALSOCKETWIN32_2, "Connect", ves_icall_Mono_PAL_Sockets_Win32_Connect)
ICALL(PALSOCKETWIN32_3, "Receive", ves_icall_Mono_PAL_Sockets_Win32_Receive)
ICALL(PALSOCKETWIN32_4, "ReceiveBuffers", ves_icall_Mono_PAL_Sockets_Win32_ReceiveBuffers)
ICALL(PALSOCKETWIN32_5, "ReceiveFrom", ves_icall_Mono_PAL_Sockets_Win32_ReceiveFrom)
ICALL(PALSOCKETWIN32_6, "Send", ves_icall_Mono_PAL_Sockets_Win32_Send)
ICALL(PALSOCKETWIN32_7, "SendBuffers", ves_icall_Mono_PAL_Sockets_Win32_SendBuffers)
ICALL(PALSOCKETWIN32_8, "SendFile", ves_icall_Mono_PAL_Sockets_Win32_SendFile)
ICALL(PALSOCKETWIN32_9, "SendTo", ves_icall_Mono_PAL_Sockets_Win32_SendTo)
#endif
...
ICALL_TYPE(SOCK, "System.Net.Sockets.Socket", SOCK_5)
