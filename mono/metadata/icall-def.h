...
ICALL(ITHREAD_5, "OnBackgroundStateChange", ves_icall_System_Threading_InternalThread_OnBackgroundStateChange)
ICALL(ITHREAD_2, "StartThreadNative", ves_icall_System_Threading_InternalThread_StartThreadNative)
...
ICALL(ITHREAD_6, "SetPriorityNative", ves_icall_System_Threading_InternalThread_SetPriorityNative)
