...
ICALL(IOSELECTOR_1, "PlatformSupportEpoll", ves_icall_System_IOSelector_PlatformSupportEpoll)
ICALL(IOSELECTOR_2, "PlatformSupportKqueue", ves_icall_System_IOSelector_PlatformSupportKqueue)
