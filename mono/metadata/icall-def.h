...
ICALL_TYPE(NATIVETHREADPIO, "System.Threading.NativeThreadPoolIOBackend", NATIVETHREADPIO_1)
ICALL(NATIVETHREADPIO_1, "Cleanup_internal", ves_icall_System_Threading_NativeThreadPoolIOBackend_Cleanup_internal)
ICALL(NATIVETHREADPIO_2, "EventGetHandleAt_internal", ves_icall_System_Threading_NativeThreadPoolIOBackend_EventGetHandleAt_internal)
ICALL(NATIVETHREADPIO_3, "EventGetHandleMax_internal", ves_icall_System_Threading_NativeThreadPoolIOBackend_EventGetHandleMax_internal)
ICALL(NATIVETHREADPIO_4, "EventResetHandleAt_internal", ves_icall_System_Threading_NativeThreadPoolIOBackend_EventResetHandleAt_internal)
ICALL(NATIVETHREADPIO_5, "EventWait_internal", ves_icall_System_Threading_NativeThreadPoolIOBackend_EventWait_internal)
ICALL(NATIVETHREADPIO_6, "Init_internal", ves_icall_System_Threading_NativeThreadPoolIOBackend_Init_internal)
ICALL(NATIVETHREADPIO_7, "SelectorThreadCreateWakeupPipes_internal", ves_icall_System_Threading_NativeThreadPoolIOBackend_SelectorThreadCreateWakeupPipes_internal)
ICALL(NATIVETHREADPIO_8, "SelectorThreadDrainWakeupPipes_internal", ves_icall_System_Threading_NativeThreadPoolIOBackend_SelectorThreadDrainWakeupPipes_internal)
ICALL(NATIVETHREADPIO_9, "SelectorThreadWakeup_internal", ves_icall_System_Threading_NativeThreadPoolIOBackend_SelectorThreadWakeup_internal)
ICALL(NATIVETHREADPIO_10, "UpdateAdd_internal", ves_icall_System_Threading_NativeThreadPoolIOBackend_UpdateAdd_internal)
