...
ICALL(ITHREAD_1 , "DecrementCriticalRegionLevel", ves_icall_System_Thread_InternalThread_DecrementCriticalRegionLevel)
ICALL(ITHREAD_2 , "GetApartmentState", ves_icall_System_Thread_InternalThread_GetApartmentState)
ICALL(ITHREAD_3 , "GetIsThreadPoolThread", ves_icall_System_Thread_InternalThread_GetIsThreadPoolThread)
ICALL(ITHREAD_4 , "GetSerializedPrincipal", ves_icall_System_Thread_InternalThread_GetSerializedPrincipal)
ICALL(ITHREAD_5 , "GetSerializedPrincipalVersion", ves_icall_System_Thread_InternalThread_GetSerializedPrincipalVersion)
ICALL(ITHREAD_6 , "GetStackSize", ves_icall_System_Thread_InternalThread_GetStackSize)
ICALL(ITHREAD_7 , "IncrementCriticalRegionLevel", ves_icall_System_Thread_InternalThread_IncrementCriticalRegionLevel)
ICALL(ITHREAD_15 , "New", ves_icall_System_Threading_InternalThread_New)
ICALL(ITHREAD_16 , "Release", ves_icall_System_Threading_InternalThread_Release)
ICALL(ITHREAD_8 , "SetApartmentState", ves_icall_System_Thread_InternalThread_SetApartmentState)
ICALL(ITHREAD_9 , "SetIsThreadPoolThread", ves_icall_System_Thread_InternalThread_SetIsThreadPoolThread)
ICALL(ITHREAD_10 , "SetSerializedPrincipal", ves_icall_System_Thread_InternalThread_SetSerializedPrincipal)
ICALL(ITHREAD_11 , "SetSerializedPrincipalVersion", ves_icall_System_Thread_InternalThread_SetSerializedPrincipalVersion)
ICALL(ITHREAD_12 , "SetStackSize", ves_icall_System_Thread_InternalThread_SetStackSize)
ICALL(ITHREAD_13 ,"get_ManagedThreadId", ves_icall_System_Thread_InternalThread_get_ManagedThreadId)
ICALL(ITHREAD_14 ,"get_ThreadId", ves_icall_System_Thread_InternalThread_get_ThreadId)
