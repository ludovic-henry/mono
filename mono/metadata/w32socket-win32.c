...
mono_w32socket_disconnect (SOCKET sock, gboolean reuse)
{
	...
	ret = WSAIoctl (sock, SIO_GET_EXTENSION_FUNCTION_POINTER, (gchar*) &guid, sizeof (GUID), (gchar*) &disconnect, sizeof (gpointer), &output_bytes);
	if (ret == 0) {
	...
	ret = WSAIoctl (sock, SIO_GET_EXTENSION_FUNCTION_POINTER, (gchar*) &guid, sizeof (GUID), (gchar*) &transmit_file, sizeof (gpointer), &output_bytes);
	if (ret == 0) {
