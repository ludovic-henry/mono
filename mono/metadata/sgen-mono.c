...
mono_gc_alloc_obj (MonoVTable *vtable, size_t size)
{
	...
	MonoHandle obj_handle = mono_handle_gc_alloc_obj (vtable, size, &error);
...
mono_gc_alloc_pinned_obj (MonoVTable *vtable, size_t size)
{
	...
	MonoHandle obj_handle = mono_handle_gc_alloc_pinned_obj (vtable, size, &error);
...
{
	MonoHandle handle = mono_handle_new (sgen_alloc_obj_pinned (vtable, size, error));
...
{
	MonoHandle handle = mono_handle_new (sgen_alloc_obj (vtable, size, error));
