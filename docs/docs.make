...
convert.exe: $(srcdir)/convert.cs AgilityPack.dll
	$(CSCOMPILE) -r:$(topdir)/class/lib/$(DEFAULT_PROFILE)$(if $(DEFAULT_PROFILE_PLATFORM),-$(DEFAULT_PROFILE_PLATFORM))/System.Xml.dll -out:$@ $< -r:AgilityPack.dll

AgilityPack.dll:
	$(CSCOMPILE) -r:$(topdir)/class/lib/$(DEFAULT_PROFILE)$(if $(DEFAULT_PROFILE_PLATFORM),-$(DEFAULT_PROFILE_PLATFORM))/System.dll -r:$(topdir)/class/lib/$(DEFAULT_PROFILE)$(if $(DEFAULT_PROFILE_PLATFORM),-$(DEFAULT_PROFILE_PLATFORM))/System.Xml.dll -target:library -out:$@ $(srcdir)/HtmlAgilityPack/*.cs
