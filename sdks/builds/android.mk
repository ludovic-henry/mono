...
## Android armv5
android_targetarmv5_CFLAGS=-D__POSIX_VISIBLE=201002 -DSK_RELEASE -DNDEBUG -UDEBUG -fpic -march=armv5te
android_targetarmv5_CXXFLAGS=-D__POSIX_VISIBLE=201002 -DSK_RELEASE -DNDEBUG -UDEBUG -fpic -march=armv5te
android_targetarmv5_LDFLAGS=-Wl,--fix-cortex-a8
$(eval $(call AndroidTargetTemplate,targetarmv5,arm,android-9,arm-linux-androideabi,arm-linux-androideabi-clang,armv5-linux-androideabi))

## Android armv7
android_targetarmv7_CFLAGS=-D__POSIX_VISIBLE=201002 -DSK_RELEASE -DNDEBUG -UDEBUG -fpic -march=armv7-a -mtune=cortex-a8 -mfpu=vfp -mfloat-abi=softfp
android_targetarmv7_CXXFLAGS=-D__POSIX_VISIBLE=201002 -DSK_RELEASE -DNDEBUG -UDEBUG -fpic -march=armv7-a -mtune=cortex-a8 -mfpu=vfp -mfloat-abi=softfp
android_targetarmv7_LDFLAGS=-Wl,--fix-cortex-a8
$(eval $(call AndroidTargetTemplate,targetarmv7,arm,android-9,arm-linux-androideabi,arm-linux-androideabi-clang,armv5-linux-androideabi))

## Android arm64
android_targetarm64_CFLAGS=-D__POSIX_VISIBLE=201002 -DSK_RELEASE -DNDEBUG -UDEBUG -fpic -DL_cuserid=9 -DANDROID64
android_targetarm64_CXXFLAGS=-D__POSIX_VISIBLE=201002 -DSK_RELEASE -DNDEBUG -UDEBUG -fpic -DL_cuserid=9 -DANDROID64
$(eval $(call AndroidTargetTemplate,targetarm64,arm64,android-21,aarch64-linux-android,aarch64-linux-android-clang,aarch64-linux-android))

## Android x86
$(eval $(call AndroidTargetTemplate,targetx86,x86,android-14,i686-linux-android,x86-clang,i686-linux-android))

## Android x86_64
android_targetx86_64_CFLAGS=-DL_cuserid=9
android_targetx86_64_CXXFLAGS=-DL_cuserid=9
$(eval $(call AndroidTargetTemplate,targetx86_64,x86_64,android-21,x86_64-linux-android,x86_64-clang,x86_64-linux-android))
