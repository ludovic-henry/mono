...
PROFILE_sources := $(firstword $(if $(PROFILE_PLATFORM),$(wildcard $(PROFILE_PLATFORM)_$(PROFILE)_$(LIBRARY).sources)) $(wildcard $(PROFILE)_$(LIBRARY).sources) $(wildcard $(if $(PROFILE_PLATFORM),$(PROFILE_PLATFORM),$(BUILD_PLATFORM))_$(LIBRARY).sources) $(wildcard $(LIBRARY).sources))
