...
ifndef BUILDMCS
BUILDMCS = MONO_PATH="$(topdir)/class/lib/$(BUILDPROFILE)-$(BUILDPLATFORM)$(PLATFORM_PATH_SEPARATOR)$$MONO_PATH" $(INTERNAL_CSC)
endif
...
BOOT_COMPILE = $(Q_MCS) $(BUILDMCS) $(USE_MCS_FLAGS)
...
ifdef MCS_MODE
INTERNAL_CSC_LOCATION = $(topdir)/class/lib/$(BUILDPROFILE)-$(BUILDPLATFORM)/mcs.exe
